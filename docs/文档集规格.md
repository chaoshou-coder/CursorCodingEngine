...
├── Rules体系.md                     # Rules 体系
├── 使用教程.md                      # 使用教程（完整示例）
├── CLI参考.md                       # codingengine CLI 命令参考
├── code-simplifier/
│   ├── 概览.md                      # code-simplifier 概览
│   └── 使用指南.md                  # 使用指南
├── 评估与基准.md                    # 评估与基准
├── 故障排查.md                      # 故障排查
├── 常见问题.md                      # 常见问题
...
- 环境准备与验证
- 完整示例：从 init 到 run.completed
- plan.json 示例与字段说明
- 在 Cursor 中使用、在其它项目中使用
- 断点续传、查看历史与统计
- 常见问题
...
- **wiki-scaffold**：创建 docs/wiki/ 目录结构及 快速开始.md 骨架（README 为首页）
- **wiki-core**：完成 架构设计、核心概念、工作流详解、Skill系统、Rules体系、配置详解
- **wiki-reference**：完成 code-simplifier 子目录文档、CLI参考
- **wiki-ops**：完成 故障排查、常见问题、Contributing、术语表
